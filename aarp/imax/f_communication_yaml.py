from aarp.common.utils import createCluster, monitorJob, destroyCluster,loadYAMLEnvVariables
import requests

def startFcomLakeJob():
	airflow_yaml_environment=loadEnvVariables()
    clusterMetaData = createCluster(name=airflow_yaml_environment['cluster_name'], num_workers=6)
