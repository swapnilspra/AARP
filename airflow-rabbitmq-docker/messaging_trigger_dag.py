...
RABBITMQ_HOST='mq-hdc.int.8451.com'
RABBITMQ_USER='ci_user'
RABBITMQ_PASS='ci_user'
RABBITMQ_VIRTUAL_HOST='ci'
...
click_dag = TriggerDagRunOperator(task_id="trigger_click_dag",
...
activity_dag = TriggerDagRunOperator(task_id="trigger_activity_dag",
...
impression_dag = TriggerDagRunOperator(task_id="trigger_impression_dag",
